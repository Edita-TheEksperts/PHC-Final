...
MANUAL_REASONS = {
    ...
    "38-39_serie_annahme": "A7 gebaut & getestet (9/9) — MA-Dashboard mit echtem MA-Login live aufnehmen.",
    ...
    "43_absenz_meldung": "A7 gebaut — «Absenz melden» im MA-Dashboard mit echtem MA-Login live aufnehmen.",
    "44_ersatz_matching": "A7 gebaut — freigegebener Termin («Ersatz nötig») im Admin live aufnehmen.",
    "45_ersatz_bestaetigt": "A7 gebaut — Ersatz-Bestätigung live aufnehmen.",
    "52_ma_dashboard": "MA-Dashboard — mit echtem MA-Login live aufnehmen (Test-Harness kann keine MA-Session injizieren).",
